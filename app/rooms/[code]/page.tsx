...
// round. Addressed by the room's short invite_code, not its internal
// UUID — a long UUID in every room-scoped URL was the actual complaint,
// and invite_code already exists/is already unique, so this reuses it
// rather than adding anything new. No invite-link joining, live
// participant list, or moderation yet — those are real Epic 04 stories,
// not touched by this pass. No session history list either: a room has
// exactly one current round, not a growing list of past ones (see
// docs/SCHEMA.md — the room-centric-rounds design).
