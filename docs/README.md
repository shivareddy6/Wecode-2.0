...
| 04 | [Rooms](./epics/04-rooms.md) | Create/join/close a room, invite links, participants | Partial — Stories 1, 2, 4, 7 done; 3 (live participant list), 5 (close room) not started; 6 out of scope; 8 (host transfer) is an uncommitted spike |
